...
io动捕数据可视化
```
ros2 launch io_robot robot_model.launch.py urdf_file:=<your_urdf_path> robot_name:=<your_robot_name> use_sim:=True use_gui:=False
```
参数解释
```
urdf_file:=/home/io/io_teleop_robot_descriptions/G1/urdf/G1.urdf    #机器人urdf路径
